      ...
      <section className='page-section'>
        <div className='page-container'>
          <div className='surface-card rounded-[2rem] p-6 md:p-8'>
            <p className='page-kicker'>Latest coverage</p>
            <div className='mt-3 flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between'>
              <div>
                <h1 className='page-title'>My Articles</h1>
                <p className='page-copy mt-4 max-w-3xl'>Read the latest stories, highlights, and features from the sports desk.</p>
              </div>
            ...
            {articles.length === 0 ? (
              <div className='mt-8 rounded-3xl border border-white/10 bg-white/5 p-6 text-slate-300'>No articles yet.</div>
            ) : null}
          </div>
            {user && user.role === 'admin' && (
          <button
